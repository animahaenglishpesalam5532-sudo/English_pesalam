...
const settingsSchema = Yup.object().shape({
  ...
  online_class_button_text: Yup.string().nullable(),
})
...
interface SettingsFormProps {
  initialValues: {
    ...
    online_class_button_text: string
  }
}
        ...
        onSubmit={async (values, { setSubmitting }) => {
          try {
            await Promise.all([
              ...
              setSetting('online_class_button_text', values.online_class_button_text || 'WhatsApp-ல் Course Details வாங்குங்கள்'),
            ])
            ...
            <Form className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex bg-gray-100/80 p-1.5 rounded-xl border border-gray-100 max-w-sm">
                    <button
                      ...
                      className={`flex-1 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${values.logo_type === 'text'
                    ...
                    <button
                      ...
                      className={`flex-1 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${values.logo_type === 'image'
                        ? 'bg-white text-blue-600 shadow-sm ring-1 ring-gray-200/50'
                        : 'text-gray-500 hover:text-gray-700 hover:bg-gray-200/50'
                        }`}
                    >
                ...
                {values.logo_type === 'text' && (
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2 border rounded-lg focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${errors.logo_text && touched.logo_text ? 'border-red-300 text-red-900' : 'border-gray-300 text-gray-700'
                        }`}
                    ...
                    return (
                      <div key={platform}>
                        ...
                        <input
                          ...
                          onBlur={() => { }}
                          className={`w-full px-4 py-2 border rounded-lg focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${fieldError && fieldTouched ? 'border-red-300' : 'border-gray-300'
                            }`}
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm space-y-6">
                ...
                <div>
                  ...
                  <input
                    name="online_class_button_text"
                    value={values.online_class_button_text}
                    onChange={(e) => setFieldValue('online_class_button_text', e.target.value)}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 sm:text-sm text-gray-700"
                    placeholder="WhatsApp-ல் Course Details வாங்குங்கள்"
                  />
                </div>
