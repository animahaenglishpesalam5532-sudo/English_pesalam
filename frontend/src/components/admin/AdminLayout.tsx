...
import { LayoutDashboard, FileText, LogOut, Menu, X, Users, Settings, QrCode, Presentation, Video, BarChart3, HelpCircle, Sparkles, Info, PhoneCall, Receipt, UserCog, ChevronDown, SquarePlay, Truck, MessageSquare } from 'lucide-react'
...
const adminGroups: NavGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'YouTube Revenue', href: '/admin/youtube-revenue', icon: SquarePlay },
  ...
  {
    title: 'Messaging',
    links: [{ name: 'WhatsApp', href: '/admin/whatsapp', icon: MessageSquare }],
  },
  {
    title: 'Content',
    links: [
