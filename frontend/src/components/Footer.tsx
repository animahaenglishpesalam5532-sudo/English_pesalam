    ...
    <footer className="border-t border-slate-200/50 bg-white/30 backdrop-blur-md">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-col items-center md:items-end text-sm text-slate-500 space-y-2">
          <p>Questions? Reach out on WhatsApp or Email:</p>
          <div className="flex flex-col items-center md:items-end space-y-1">
            ...
            <a href="mailto:englishpesalam11@gmail.com" className="font-semibold text-brand-blue hover:text-brand-green transition-colors">
              englishpesalam11@gmail.com
            </a>
          </div>
